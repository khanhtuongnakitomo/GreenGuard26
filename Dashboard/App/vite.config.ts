/// <reference path="./frontend/prerender/types.d.ts" />
...
import { getBlogRoutes } from './frontend/prerender/blog-routes.js';
import { getSitemapLastmod } from './frontend/prerender/blog-sitemap.js';
  ...
  return {
    ...
    plugins: [
      ...
      ...(blogPrerenderRoutes.length > 0
        ? vitePrerenderPlugin({
            renderTarget: '#root',
            prerenderScript: path.resolve(__dirname, 'frontend/prerender/blog.js'),
